...
describe("Search products", () => {
  ...
  test("Given 'polo'; it should return all the products which has polo in the name or type or color  attribute", () => {
    expect(getSearchedProducts(products, "polo")).toStrictEqual([products[0]]);
  });
});
